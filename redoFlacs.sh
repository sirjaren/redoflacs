...
#-----------
# 0.8   [03/29/12]
#         --Added new argument (--aucdtect,-a) to allow use of
#           auCDtect command to test FLAC validity (determine
#           whether FLAC is lossy sourced)
#         --Addded configurable auCDtect command location under
#           USER CONFIGURATION
#         --Code cleanup
#           readable)
